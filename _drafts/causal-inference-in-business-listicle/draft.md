...
That indicates how valuable a feature could be, and signal that we can further invest in this feature. No diff-in-diff, nor IPSW, nor A/B test: but if these answers return negative, would a precise causal inference matter still?
...
<!--[insert image displaying the collider bias - drawn, scatterplot showing that conditioning on high values of x can induce negative relationships between z and y]-->
